...
CONTAINS
  SUBROUTINE xios_set_calendar_wrapper_attr &
    ...
    IMPLICIT NONE
      TYPE(xios_calendar_wrapper) :: calendar_wrapper_hdl
      ...
      CALL xios_get_calendar_wrapper_handle &
      (calendar_wrapper_id,calendar_wrapper_hdl)
      CALL xios_set_calendar_wrapper_attr_hdl_ &
      ( calendar_wrapper_hdl, comment, day_length, leap_year_drift, leap_year_drift_offset, leap_year_month &
      , month_lengths, start_date, time_origin, timestep, type, year_length )
  END SUBROUTINE xios_set_calendar_wrapper_attr
  SUBROUTINE xios_set_calendar_wrapper_attr_hdl &
    ( calendar_wrapper_hdl, comment, day_length, leap_year_drift, leap_year_drift_offset, leap_year_month &
    , month_lengths, start_date, time_origin, timestep, type, year_length )
    IMPLICIT NONE
      TYPE(xios_calendar_wrapper) , INTENT(IN) :: calendar_wrapper_hdl
      CHARACTER(len = *) , OPTIONAL, INTENT(IN) :: comment
      INTEGER , OPTIONAL, INTENT(IN) :: day_length
      REAL (KIND=8) , OPTIONAL, INTENT(IN) :: leap_year_drift
      REAL (KIND=8) , OPTIONAL, INTENT(IN) :: leap_year_drift_offset
      ...
      ( calendar_wrapper_hdl, comment, day_length, leap_year_drift, leap_year_drift_offset, leap_year_month &
      , month_lengths, start_date, time_origin, timestep, type, year_length )
  END SUBROUTINE xios_set_calendar_wrapper_attr_hdl
  SUBROUTINE xios_set_calendar_wrapper_attr_hdl_ &
    ...
    IMPLICIT NONE
      ...
      TYPE(xios_duration) , OPTIONAL, INTENT(IN) :: timestep_
      ...
      ENDIF
  END SUBROUTINE xios_set_calendar_wrapper_attr_hdl_
  SUBROUTINE xios_get_calendar_wrapper_attr &
    ( calendar_wrapper_id, comment, day_length, leap_year_drift, leap_year_drift_offset, leap_year_month &
    , month_lengths, start_date, time_origin, timestep, type, year_length )
    IMPLICIT NONE
      TYPE(xios_calendar_wrapper) :: calendar_wrapper_hdl
      ...
      TYPE(xios_duration) , OPTIONAL, INTENT(OUT) :: timestep
      CHARACTER(len = *) , OPTIONAL, INTENT(OUT) :: type
      INTEGER , OPTIONAL, INTENT(OUT) :: year_length
      CALL xios_get_calendar_wrapper_handle &
      (calendar_wrapper_id,calendar_wrapper_hdl)
      CALL xios_get_calendar_wrapper_attr_hdl_ &
      ( calendar_wrapper_hdl, comment, day_length, leap_year_drift, leap_year_drift_offset, leap_year_month &
      , month_lengths, start_date, time_origin, timestep, type, year_length )
  END SUBROUTINE xios_get_calendar_wrapper_attr
  SUBROUTINE xios_get_calendar_wrapper_attr_hdl &
    ( calendar_wrapper_hdl, comment, day_length, leap_year_drift, leap_year_drift_offset, leap_year_month &
    , month_lengths, start_date, time_origin, timestep, type, year_length )
    IMPLICIT NONE
      TYPE(xios_calendar_wrapper) , INTENT(IN) :: calendar_wrapper_hdl
      ...
      ( calendar_wrapper_hdl, comment, day_length, leap_year_drift, leap_year_drift_offset, leap_year_month &
      , month_lengths, start_date, time_origin, timestep, type, year_length )
  END SUBROUTINE xios_get_calendar_wrapper_attr_hdl
  SUBROUTINE xios_get_calendar_wrapper_attr_hdl_ &
    ( calendar_wrapper_hdl, comment_, day_length_, leap_year_drift_, leap_year_drift_offset_, leap_year_month_ &
    , month_lengths_, start_date_, time_origin_, timestep_, type_, year_length_ )
    IMPLICIT NONE
      TYPE(xios_calendar_wrapper) , INTENT(IN) :: calendar_wrapper_hdl
      ...
      TYPE(xios_duration) , OPTIONAL, INTENT(OUT) :: timestep_
      ...
      (calendar_wrapper_hdl%daddr, year_length_)
      ENDIF
  END SUBROUTINE xios_get_calendar_wrapper_attr_hdl_
  SUBROUTINE xios_is_defined_calendar_wrapper_attr &
    ( calendar_wrapper_id, comment, day_length, leap_year_drift, leap_year_drift_offset, leap_year_month &
    , month_lengths, start_date, time_origin, timestep, type, year_length )
    IMPLICIT NONE
      TYPE(xios_calendar_wrapper) :: calendar_wrapper_hdl
      ...
      CALL xios_get_calendar_wrapper_handle &
      (calendar_wrapper_id,calendar_wrapper_hdl)
      CALL xios_is_defined_calendar_wrapper_attr_hdl_ &
      ( calendar_wrapper_hdl, comment, day_length, leap_year_drift, leap_year_drift_offset, leap_year_month &
      , month_lengths, start_date, time_origin, timestep, type, year_length )
  END SUBROUTINE xios_is_defined_calendar_wrapper_attr
  SUBROUTINE xios_is_defined_calendar_wrapper_attr_hdl &
    ( calendar_wrapper_hdl, comment, day_length, leap_year_drift, leap_year_drift_offset, leap_year_month &
    , month_lengths, start_date, time_origin, timestep, type, year_length )
    IMPLICIT NONE
      TYPE(xios_calendar_wrapper) , INTENT(IN) :: calendar_wrapper_hdl
      ...
      ( calendar_wrapper_hdl, comment, day_length, leap_year_drift, leap_year_drift_offset, leap_year_month &
      , month_lengths, start_date, time_origin, timestep, type, year_length )
  END SUBROUTINE xios_is_defined_calendar_wrapper_attr_hdl
  SUBROUTINE xios_is_defined_calendar_wrapper_attr_hdl_ &
    ( calendar_wrapper_hdl, comment_, day_length_, leap_year_drift_, leap_year_drift_offset_, leap_year_month_ &
    , month_lengths_, start_date_, time_origin_, timestep_, type_, year_length_ )
    IMPLICIT NONE
      TYPE(xios_calendar_wrapper) , INTENT(IN) :: calendar_wrapper_hdl
      ...
      ENDIF
  END SUBROUTINE xios_is_defined_calendar_wrapper_attr_hdl_
