...
CONTAINS
  SUBROUTINE xios_set_gridgroup_attr &
    ...
    IMPLICIT NONE
      ...
      CALL xios_get_gridgroup_handle &
      (gridgroup_id,gridgroup_hdl)
      CALL xios_set_gridgroup_attr_hdl_ &
      ( gridgroup_hdl, comment, description, group_ref, mask_0d, mask_1d, mask_2d, mask_3d, mask_4d &
      , mask_5d, mask_6d, mask_7d, name )
  END SUBROUTINE xios_set_gridgroup_attr
  SUBROUTINE xios_set_gridgroup_attr_hdl &
    ( gridgroup_hdl, comment, description, group_ref, mask_0d, mask_1d, mask_2d, mask_3d, mask_4d &
    , mask_5d, mask_6d, mask_7d, name )
    IMPLICIT NONE
      TYPE(xios_gridgroup) , INTENT(IN) :: gridgroup_hdl
      CHARACTER(len = *) , OPTIONAL, INTENT(IN) :: comment
      CHARACTER(len = *) , OPTIONAL, INTENT(IN) :: description
      CHARACTER(len = *) , OPTIONAL, INTENT(IN) :: group_ref
      LOGICAL , OPTIONAL, INTENT(IN) :: mask_0d(:)
      ...
      ( gridgroup_hdl, comment, description, group_ref, mask_0d, mask_1d, mask_2d, mask_3d, mask_4d &
      , mask_5d, mask_6d, mask_7d, name )
  END SUBROUTINE xios_set_gridgroup_attr_hdl
  SUBROUTINE xios_set_gridgroup_attr_hdl_ &
    ...
    IMPLICIT NONE
      ...
      ENDIF
  END SUBROUTINE xios_set_gridgroup_attr_hdl_
  SUBROUTINE xios_get_gridgroup_attr &
    ( gridgroup_id, comment, description, group_ref, mask_0d, mask_1d, mask_2d, mask_3d, mask_4d &
    , mask_5d, mask_6d, mask_7d, name )
    IMPLICIT NONE
      TYPE(xios_gridgroup) :: gridgroup_hdl
      ...
      CALL xios_get_gridgroup_handle &
      (gridgroup_id,gridgroup_hdl)
      CALL xios_get_gridgroup_attr_hdl_ &
      ( gridgroup_hdl, comment, description, group_ref, mask_0d, mask_1d, mask_2d, mask_3d, mask_4d &
      , mask_5d, mask_6d, mask_7d, name )
  END SUBROUTINE xios_get_gridgroup_attr
  SUBROUTINE xios_get_gridgroup_attr_hdl &
    ( gridgroup_hdl, comment, description, group_ref, mask_0d, mask_1d, mask_2d, mask_3d, mask_4d &
    , mask_5d, mask_6d, mask_7d, name )
    IMPLICIT NONE
      TYPE(xios_gridgroup) , INTENT(IN) :: gridgroup_hdl
      ...
      ( gridgroup_hdl, comment, description, group_ref, mask_0d, mask_1d, mask_2d, mask_3d, mask_4d &
      , mask_5d, mask_6d, mask_7d, name )
  END SUBROUTINE xios_get_gridgroup_attr_hdl
  SUBROUTINE xios_get_gridgroup_attr_hdl_ &
    ( gridgroup_hdl, comment_, description_, group_ref_, mask_0d_, mask_1d_, mask_2d_, mask_3d_ &
    , mask_4d_, mask_5d_, mask_6d_, mask_7d_, name_ )
    IMPLICIT NONE
      TYPE(xios_gridgroup) , INTENT(IN) :: gridgroup_hdl
      ...
      (gridgroup_hdl%daddr, name_, len(name_))
      ENDIF
  END SUBROUTINE xios_get_gridgroup_attr_hdl_
  SUBROUTINE xios_is_defined_gridgroup_attr &
    ( gridgroup_id, comment, description, group_ref, mask_0d, mask_1d, mask_2d, mask_3d, mask_4d &
    , mask_5d, mask_6d, mask_7d, name )
    IMPLICIT NONE
      TYPE(xios_gridgroup) :: gridgroup_hdl
      ...
      CALL xios_get_gridgroup_handle &
      (gridgroup_id,gridgroup_hdl)
      CALL xios_is_defined_gridgroup_attr_hdl_ &
      ( gridgroup_hdl, comment, description, group_ref, mask_0d, mask_1d, mask_2d, mask_3d, mask_4d &
      , mask_5d, mask_6d, mask_7d, name )
  END SUBROUTINE xios_is_defined_gridgroup_attr
  SUBROUTINE xios_is_defined_gridgroup_attr_hdl &
    ( gridgroup_hdl, comment, description, group_ref, mask_0d, mask_1d, mask_2d, mask_3d, mask_4d &
    , mask_5d, mask_6d, mask_7d, name )
    IMPLICIT NONE
      TYPE(xios_gridgroup) , INTENT(IN) :: gridgroup_hdl
      ...
      ( gridgroup_hdl, comment, description, group_ref, mask_0d, mask_1d, mask_2d, mask_3d, mask_4d &
      , mask_5d, mask_6d, mask_7d, name )
  END SUBROUTINE xios_is_defined_gridgroup_attr_hdl
  SUBROUTINE xios_is_defined_gridgroup_attr_hdl_ &
    ( gridgroup_hdl, comment_, description_, group_ref_, mask_0d_, mask_1d_, mask_2d_, mask_3d_ &
    , mask_4d_, mask_5d_, mask_6d_, mask_7d_, name_ )
    IMPLICIT NONE
      TYPE(xios_gridgroup) , INTENT(IN) :: gridgroup_hdl
      ...
      (gridgroup_hdl%daddr)
        name_ = name__tmp
      ENDIF
  END SUBROUTINE xios_is_defined_gridgroup_attr_hdl_
