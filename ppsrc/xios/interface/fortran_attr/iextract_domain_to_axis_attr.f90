...
CONTAINS
  SUBROUTINE xios_set_extract_domain_to_axis_attr &
    ( extract_domain_to_axis_id, direction, position )
    IMPLICIT NONE
      TYPE(xios_extract_domain_to_axis) :: extract_domain_to_axis_hdl
      CHARACTER(LEN=*), INTENT(IN) ::extract_domain_to_axis_id
      CHARACTER(len = *) , OPTIONAL, INTENT(IN) :: direction
      INTEGER , OPTIONAL, INTENT(IN) :: position
      CALL xios_get_extract_domain_to_axis_handle &
      (extract_domain_to_axis_id,extract_domain_to_axis_hdl)
      CALL xios_set_extract_domain_to_axis_attr_hdl_ &
      ( extract_domain_to_axis_hdl, direction, position )
  END SUBROUTINE xios_set_extract_domain_to_axis_attr
  SUBROUTINE xios_set_extract_domain_to_axis_attr_hdl &
    ( extract_domain_to_axis_hdl, direction, position )
    IMPLICIT NONE
      TYPE(xios_extract_domain_to_axis) , INTENT(IN) :: extract_domain_to_axis_hdl
      CHARACTER(len = *) , OPTIONAL, INTENT(IN) :: direction
      INTEGER , OPTIONAL, INTENT(IN) :: position
      CALL xios_set_extract_domain_to_axis_attr_hdl_ &
      ( extract_domain_to_axis_hdl, direction, position )
  END SUBROUTINE xios_set_extract_domain_to_axis_attr_hdl
  SUBROUTINE xios_set_extract_domain_to_axis_attr_hdl_ &
    ...
    IMPLICIT NONE
      ...
      ENDIF
  END SUBROUTINE xios_set_extract_domain_to_axis_attr_hdl_
  SUBROUTINE xios_get_extract_domain_to_axis_attr &
    ( extract_domain_to_axis_id, direction, position )
    IMPLICIT NONE
      TYPE(xios_extract_domain_to_axis) :: extract_domain_to_axis_hdl
      CHARACTER(LEN=*), INTENT(IN) ::extract_domain_to_axis_id
      ...
      CALL xios_get_extract_domain_to_axis_handle &
      (extract_domain_to_axis_id,extract_domain_to_axis_hdl)
      CALL xios_get_extract_domain_to_axis_attr_hdl_ &
      ( extract_domain_to_axis_hdl, direction, position )
  END SUBROUTINE xios_get_extract_domain_to_axis_attr
  SUBROUTINE xios_get_extract_domain_to_axis_attr_hdl &
    ( extract_domain_to_axis_hdl, direction, position )
    IMPLICIT NONE
      TYPE(xios_extract_domain_to_axis) , INTENT(IN) :: extract_domain_to_axis_hdl
      CHARACTER(len = *) , OPTIONAL, INTENT(OUT) :: direction
      ...
      CALL xios_get_extract_domain_to_axis_attr_hdl_ &
      ( extract_domain_to_axis_hdl, direction, position )
  END SUBROUTINE xios_get_extract_domain_to_axis_attr_hdl
  SUBROUTINE xios_get_extract_domain_to_axis_attr_hdl_ &
    ( extract_domain_to_axis_hdl, direction_, position_ )
    IMPLICIT NONE
      TYPE(xios_extract_domain_to_axis) , INTENT(IN) :: extract_domain_to_axis_hdl
      ...
      (extract_domain_to_axis_hdl%daddr, position_)
      ENDIF
  END SUBROUTINE xios_get_extract_domain_to_axis_attr_hdl_
  SUBROUTINE xios_is_defined_extract_domain_to_axis_attr &
    ( extract_domain_to_axis_id, direction, position )
    IMPLICIT NONE
      TYPE(xios_extract_domain_to_axis) :: extract_domain_to_axis_hdl
      CHARACTER(LEN=*), INTENT(IN) ::extract_domain_to_axis_id
      ...
      CALL xios_get_extract_domain_to_axis_handle &
      (extract_domain_to_axis_id,extract_domain_to_axis_hdl)
      CALL xios_is_defined_extract_domain_to_axis_attr_hdl_ &
      ( extract_domain_to_axis_hdl, direction, position )
  END SUBROUTINE xios_is_defined_extract_domain_to_axis_attr
  SUBROUTINE xios_is_defined_extract_domain_to_axis_attr_hdl &
    ( extract_domain_to_axis_hdl, direction, position )
    IMPLICIT NONE
      TYPE(xios_extract_domain_to_axis) , INTENT(IN) :: extract_domain_to_axis_hdl
      LOGICAL, OPTIONAL, INTENT(OUT) :: direction
      ...
      CALL xios_is_defined_extract_domain_to_axis_attr_hdl_ &
      ( extract_domain_to_axis_hdl, direction, position )
  END SUBROUTINE xios_is_defined_extract_domain_to_axis_attr_hdl
  SUBROUTINE xios_is_defined_extract_domain_to_axis_attr_hdl_ &
    ( extract_domain_to_axis_hdl, direction_, position_ )
    IMPLICIT NONE
      TYPE(xios_extract_domain_to_axis) , INTENT(IN) :: extract_domain_to_axis_hdl
      ...
      ENDIF
  END SUBROUTINE xios_is_defined_extract_domain_to_axis_attr_hdl_
