...
CONTAINS
  SUBROUTINE xios_set_interpolate_domain_attr &
    ...
    IMPLICIT NONE
      TYPE(xios_interpolate_domain) :: interpolate_domain_hdl
      ...
      CALL xios_get_interpolate_domain_handle &
      (interpolate_domain_id,interpolate_domain_hdl)
      CALL xios_set_interpolate_domain_attr_hdl_ &
      ( interpolate_domain_hdl, detect_missing_value, mode, order, quantity, read_write_convention &
      , renormalize, use_area, weight_filename, write_weight )
  END SUBROUTINE xios_set_interpolate_domain_attr
  SUBROUTINE xios_set_interpolate_domain_attr_hdl &
    ( interpolate_domain_hdl, detect_missing_value, mode, order, quantity, read_write_convention &
    , renormalize, use_area, weight_filename, write_weight )
    IMPLICIT NONE
      TYPE(xios_interpolate_domain) , INTENT(IN) :: interpolate_domain_hdl
      LOGICAL , OPTIONAL, INTENT(IN) :: detect_missing_value
      LOGICAL (KIND=C_BOOL) :: detect_missing_value_tmp
      CHARACTER(len = *) , OPTIONAL, INTENT(IN) :: mode
      INTEGER , OPTIONAL, INTENT(IN) :: order
      ...
      ( interpolate_domain_hdl, detect_missing_value, mode, order, quantity, read_write_convention &
      , renormalize, use_area, weight_filename, write_weight )
  END SUBROUTINE xios_set_interpolate_domain_attr_hdl
  SUBROUTINE xios_set_interpolate_domain_attr_hdl_ &
    ...
    IMPLICIT NONE
      ...
      ENDIF
  END SUBROUTINE xios_set_interpolate_domain_attr_hdl_
  SUBROUTINE xios_get_interpolate_domain_attr &
    ( interpolate_domain_id, detect_missing_value, mode, order, quantity, read_write_convention &
    , renormalize, use_area, weight_filename, write_weight )
    IMPLICIT NONE
      TYPE(xios_interpolate_domain) :: interpolate_domain_hdl
      ...
      CALL xios_get_interpolate_domain_handle &
      (interpolate_domain_id,interpolate_domain_hdl)
      CALL xios_get_interpolate_domain_attr_hdl_ &
      ( interpolate_domain_hdl, detect_missing_value, mode, order, quantity, read_write_convention &
      , renormalize, use_area, weight_filename, write_weight )
  END SUBROUTINE xios_get_interpolate_domain_attr
  SUBROUTINE xios_get_interpolate_domain_attr_hdl &
    ( interpolate_domain_hdl, detect_missing_value, mode, order, quantity, read_write_convention &
    , renormalize, use_area, weight_filename, write_weight )
    IMPLICIT NONE
      TYPE(xios_interpolate_domain) , INTENT(IN) :: interpolate_domain_hdl
      ...
      ( interpolate_domain_hdl, detect_missing_value, mode, order, quantity, read_write_convention &
      , renormalize, use_area, weight_filename, write_weight )
  END SUBROUTINE xios_get_interpolate_domain_attr_hdl
  SUBROUTINE xios_get_interpolate_domain_attr_hdl_ &
    ( interpolate_domain_hdl, detect_missing_value_, mode_, order_, quantity_, read_write_convention_ &
    , renormalize_, use_area_, weight_filename_, write_weight_ )
    IMPLICIT NONE
      TYPE(xios_interpolate_domain) , INTENT(IN) :: interpolate_domain_hdl
      ...
      ENDIF
  END SUBROUTINE xios_get_interpolate_domain_attr_hdl_
  SUBROUTINE xios_is_defined_interpolate_domain_attr &
    ( interpolate_domain_id, detect_missing_value, mode, order, quantity, read_write_convention &
    , renormalize, use_area, weight_filename, write_weight )
    IMPLICIT NONE
      TYPE(xios_interpolate_domain) :: interpolate_domain_hdl
      ...
      CALL xios_get_interpolate_domain_handle &
      (interpolate_domain_id,interpolate_domain_hdl)
      CALL xios_is_defined_interpolate_domain_attr_hdl_ &
      ( interpolate_domain_hdl, detect_missing_value, mode, order, quantity, read_write_convention &
      , renormalize, use_area, weight_filename, write_weight )
  END SUBROUTINE xios_is_defined_interpolate_domain_attr
  SUBROUTINE xios_is_defined_interpolate_domain_attr_hdl &
    ( interpolate_domain_hdl, detect_missing_value, mode, order, quantity, read_write_convention &
    , renormalize, use_area, weight_filename, write_weight )
    IMPLICIT NONE
      TYPE(xios_interpolate_domain) , INTENT(IN) :: interpolate_domain_hdl
      ...
      ( interpolate_domain_hdl, detect_missing_value, mode, order, quantity, read_write_convention &
      , renormalize, use_area, weight_filename, write_weight )
  END SUBROUTINE xios_is_defined_interpolate_domain_attr_hdl
  SUBROUTINE xios_is_defined_interpolate_domain_attr_hdl_ &
    ( interpolate_domain_hdl, detect_missing_value_, mode_, order_, quantity_, read_write_convention_ &
    , renormalize_, use_area_, weight_filename_, write_weight_ )
    IMPLICIT NONE
      TYPE(xios_interpolate_domain) , INTENT(IN) :: interpolate_domain_hdl
      ...
      (interpolate_domain_hdl%daddr)
        write_weight_ = write_weight__tmp
      ENDIF
  END SUBROUTINE xios_is_defined_interpolate_domain_attr_hdl_
