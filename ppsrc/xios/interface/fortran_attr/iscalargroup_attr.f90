...
CONTAINS
  SUBROUTINE xios_set_scalargroup_attr &
    ...
    IMPLICIT NONE
      ...
      CALL xios_get_scalargroup_handle &
      (scalargroup_id,scalargroup_hdl)
      CALL xios_set_scalargroup_attr_hdl_ &
      ( scalargroup_hdl, axis_type, bounds, bounds_name, comment, group_ref, label, long_name, name &
      , positive, prec, scalar_ref, standard_name, unit, value )
  END SUBROUTINE xios_set_scalargroup_attr
  SUBROUTINE xios_set_scalargroup_attr_hdl &
    ( scalargroup_hdl, axis_type, bounds, bounds_name, comment, group_ref, label, long_name, name &
    , positive, prec, scalar_ref, standard_name, unit, value )
    IMPLICIT NONE
      TYPE(xios_scalargroup) , INTENT(IN) :: scalargroup_hdl
      CHARACTER(len = *) , OPTIONAL, INTENT(IN) :: axis_type
      REAL (KIND=8) , OPTIONAL, INTENT(IN) :: bounds(:)
      CHARACTER(len = *) , OPTIONAL, INTENT(IN) :: bounds_name
      CHARACTER(len = *) , OPTIONAL, INTENT(IN) :: comment
      ...
      ( scalargroup_hdl, axis_type, bounds, bounds_name, comment, group_ref, label, long_name, name &
      , positive, prec, scalar_ref, standard_name, unit, value )
  END SUBROUTINE xios_set_scalargroup_attr_hdl
  SUBROUTINE xios_set_scalargroup_attr_hdl_ &
    ...
    IMPLICIT NONE
      ...
      ENDIF
  END SUBROUTINE xios_set_scalargroup_attr_hdl_
  SUBROUTINE xios_get_scalargroup_attr &
    ( scalargroup_id, axis_type, bounds, bounds_name, comment, group_ref, label, long_name, name &
    , positive, prec, scalar_ref, standard_name, unit, value )
    IMPLICIT NONE
      TYPE(xios_scalargroup) :: scalargroup_hdl
      ...
      CALL xios_get_scalargroup_handle &
      (scalargroup_id,scalargroup_hdl)
      CALL xios_get_scalargroup_attr_hdl_ &
      ( scalargroup_hdl, axis_type, bounds, bounds_name, comment, group_ref, label, long_name, name &
      , positive, prec, scalar_ref, standard_name, unit, value )
  END SUBROUTINE xios_get_scalargroup_attr
  SUBROUTINE xios_get_scalargroup_attr_hdl &
    ( scalargroup_hdl, axis_type, bounds, bounds_name, comment, group_ref, label, long_name, name &
    , positive, prec, scalar_ref, standard_name, unit, value )
    IMPLICIT NONE
      TYPE(xios_scalargroup) , INTENT(IN) :: scalargroup_hdl
      ...
      ( scalargroup_hdl, axis_type, bounds, bounds_name, comment, group_ref, label, long_name, name &
      , positive, prec, scalar_ref, standard_name, unit, value )
  END SUBROUTINE xios_get_scalargroup_attr_hdl
  SUBROUTINE xios_get_scalargroup_attr_hdl_ &
    ( scalargroup_hdl, axis_type_, bounds_, bounds_name_, comment_, group_ref_, label_, long_name_ &
    , name_, positive_, prec_, scalar_ref_, standard_name_, unit_, value_ )
    IMPLICIT NONE
      TYPE(xios_scalargroup) , INTENT(IN) :: scalargroup_hdl
      ...
      (scalargroup_hdl%daddr, value_)
      ENDIF
  END SUBROUTINE xios_get_scalargroup_attr_hdl_
  SUBROUTINE xios_is_defined_scalargroup_attr &
    ( scalargroup_id, axis_type, bounds, bounds_name, comment, group_ref, label, long_name, name &
    , positive, prec, scalar_ref, standard_name, unit, value )
    IMPLICIT NONE
      TYPE(xios_scalargroup) :: scalargroup_hdl
      ...
      CALL xios_get_scalargroup_handle &
      (scalargroup_id,scalargroup_hdl)
      CALL xios_is_defined_scalargroup_attr_hdl_ &
      ( scalargroup_hdl, axis_type, bounds, bounds_name, comment, group_ref, label, long_name, name &
      , positive, prec, scalar_ref, standard_name, unit, value )
  END SUBROUTINE xios_is_defined_scalargroup_attr
  SUBROUTINE xios_is_defined_scalargroup_attr_hdl &
    ( scalargroup_hdl, axis_type, bounds, bounds_name, comment, group_ref, label, long_name, name &
    , positive, prec, scalar_ref, standard_name, unit, value )
    IMPLICIT NONE
      TYPE(xios_scalargroup) , INTENT(IN) :: scalargroup_hdl
      ...
      ( scalargroup_hdl, axis_type, bounds, bounds_name, comment, group_ref, label, long_name, name &
      , positive, prec, scalar_ref, standard_name, unit, value )
  END SUBROUTINE xios_is_defined_scalargroup_attr_hdl
  SUBROUTINE xios_is_defined_scalargroup_attr_hdl_ &
    ( scalargroup_hdl, axis_type_, bounds_, bounds_name_, comment_, group_ref_, label_, long_name_ &
    , name_, positive_, prec_, scalar_ref_, standard_name_, unit_, value_ )
    IMPLICIT NONE
      TYPE(xios_scalargroup) , INTENT(IN) :: scalargroup_hdl
      ...
      (scalargroup_hdl%daddr)
        value_ = value__tmp
      ENDIF
  END SUBROUTINE xios_is_defined_scalargroup_attr_hdl_
