...
CONTAINS
  SUBROUTINE xios_set_generate_rectilinear_domain_attr &
    ...
    IMPLICIT NONE
      TYPE(xios_generate_rectilinear_domain) :: generate_rectilinear_domain_hdl
      ...
      CALL xios_get_generate_rectilinear_domain_handle &
      (generate_rectilinear_domain_id,generate_rectilinear_domain_hdl)
      CALL xios_set_generate_rectilinear_domain_attr_hdl_ &
  ...
  SUBROUTINE xios_set_generate_rectilinear_domain_attr_hdl &
    ( generate_rectilinear_domain_hdl, bounds_lat_end, bounds_lat_start, bounds_lon_end, bounds_lon_start &
    , lat_end, lat_start, lon_end, lon_start )
    IMPLICIT NONE
      TYPE(xios_generate_rectilinear_domain) , INTENT(IN) :: generate_rectilinear_domain_hdl
      REAL (KIND=8) , OPTIONAL, INTENT(IN) :: bounds_lat_end
      REAL (KIND=8) , OPTIONAL, INTENT(IN) :: bounds_lat_start
      REAL (KIND=8) , OPTIONAL, INTENT(IN) :: bounds_lon_end
      REAL (KIND=8) , OPTIONAL, INTENT(IN) :: bounds_lon_start
      ...
      ( generate_rectilinear_domain_hdl, bounds_lat_end, bounds_lat_start, bounds_lon_end, bounds_lon_start &
      , lat_end, lat_start, lon_end, lon_start )
  END SUBROUTINE xios_set_generate_rectilinear_domain_attr_hdl
  SUBROUTINE xios_set_generate_rectilinear_domain_attr_hdl_ &
    ...
    IMPLICIT NONE
      ...
      ENDIF
  END SUBROUTINE xios_set_generate_rectilinear_domain_attr_hdl_
  SUBROUTINE xios_get_generate_rectilinear_domain_attr &
    ( generate_rectilinear_domain_id, bounds_lat_end, bounds_lat_start, bounds_lon_end, bounds_lon_start &
    , lat_end, lat_start, lon_end, lon_start )
    IMPLICIT NONE
      TYPE(xios_generate_rectilinear_domain) :: generate_rectilinear_domain_hdl
      ...
      CALL xios_get_generate_rectilinear_domain_handle &
      (generate_rectilinear_domain_id,generate_rectilinear_domain_hdl)
      CALL xios_get_generate_rectilinear_domain_attr_hdl_ &
      ( generate_rectilinear_domain_hdl, bounds_lat_end, bounds_lat_start, bounds_lon_end, bounds_lon_start &
      , lat_end, lat_start, lon_end, lon_start )
  END SUBROUTINE xios_get_generate_rectilinear_domain_attr
  SUBROUTINE xios_get_generate_rectilinear_domain_attr_hdl &
    ( generate_rectilinear_domain_hdl, bounds_lat_end, bounds_lat_start, bounds_lon_end, bounds_lon_start &
    , lat_end, lat_start, lon_end, lon_start )
    IMPLICIT NONE
      TYPE(xios_generate_rectilinear_domain) , INTENT(IN) :: generate_rectilinear_domain_hdl
      ...
      ( generate_rectilinear_domain_hdl, bounds_lat_end, bounds_lat_start, bounds_lon_end, bounds_lon_start &
      , lat_end, lat_start, lon_end, lon_start )
  END SUBROUTINE xios_get_generate_rectilinear_domain_attr_hdl
  SUBROUTINE xios_get_generate_rectilinear_domain_attr_hdl_ &
    ( generate_rectilinear_domain_hdl, bounds_lat_end_, bounds_lat_start_, bounds_lon_end_, bounds_lon_start_ &
    , lat_end_, lat_start_, lon_end_, lon_start_ )
    IMPLICIT NONE
      TYPE(xios_generate_rectilinear_domain) , INTENT(IN) :: generate_rectilinear_domain_hdl
      ...
      (generate_rectilinear_domain_hdl%daddr, lon_start_)
      ENDIF
  END SUBROUTINE xios_get_generate_rectilinear_domain_attr_hdl_
  SUBROUTINE xios_is_defined_generate_rectilinear_domain_attr &
    ( generate_rectilinear_domain_id, bounds_lat_end, bounds_lat_start, bounds_lon_end, bounds_lon_start &
    , lat_end, lat_start, lon_end, lon_start )
    IMPLICIT NONE
      TYPE(xios_generate_rectilinear_domain) :: generate_rectilinear_domain_hdl
      ...
      CALL xios_get_generate_rectilinear_domain_handle &
      (generate_rectilinear_domain_id,generate_rectilinear_domain_hdl)
      CALL xios_is_defined_generate_rectilinear_domain_attr_hdl_ &
      ( generate_rectilinear_domain_hdl, bounds_lat_end, bounds_lat_start, bounds_lon_end, bounds_lon_start &
      , lat_end, lat_start, lon_end, lon_start )
  END SUBROUTINE xios_is_defined_generate_rectilinear_domain_attr
  SUBROUTINE xios_is_defined_generate_rectilinear_domain_attr_hdl &
    ( generate_rectilinear_domain_hdl, bounds_lat_end, bounds_lat_start, bounds_lon_end, bounds_lon_start &
    , lat_end, lat_start, lon_end, lon_start )
    IMPLICIT NONE
      TYPE(xios_generate_rectilinear_domain) , INTENT(IN) :: generate_rectilinear_domain_hdl
      ...
      ( generate_rectilinear_domain_hdl, bounds_lat_end, bounds_lat_start, bounds_lon_end, bounds_lon_start &
      , lat_end, lat_start, lon_end, lon_start )
  END SUBROUTINE xios_is_defined_generate_rectilinear_domain_attr_hdl
  SUBROUTINE xios_is_defined_generate_rectilinear_domain_attr_hdl_ &
    ( generate_rectilinear_domain_hdl, bounds_lat_end_, bounds_lat_start_, bounds_lon_end_, bounds_lon_start_ &
    , lat_end_, lat_start_, lon_end_, lon_start_ )
    IMPLICIT NONE
      TYPE(xios_generate_rectilinear_domain) , INTENT(IN) :: generate_rectilinear_domain_hdl
      ...
      ENDIF
  END SUBROUTINE xios_is_defined_generate_rectilinear_domain_attr_hdl_
