...
CONTAINS
  SUBROUTINE xios_set_domaingroup_attr &
    ...
    IMPLICIT NONE
      ...
      CALL xios_get_domaingroup_handle &
      (domaingroup_id,domaingroup_hdl)
      CALL xios_set_domaingroup_attr_hdl_ &
  ...
  END SUBROUTINE xios_set_domaingroup_attr
  SUBROUTINE xios_set_domaingroup_attr_hdl &
    ( domaingroup_hdl, area, bounds_lat_1d, bounds_lat_2d, bounds_lat_name, bounds_lon_1d, bounds_lon_2d &
    , bounds_lon_name, comment, data_dim, data_i_index, data_ibegin, data_j_index, data_jbegin, data_ni &
    , data_nj, dim_i_name, dim_j_name, domain_ref, group_ref, i_index, ibegin, j_index, jbegin, lat_name &
    , latvalue_1d, latvalue_2d, lon_name, long_name, lonvalue_1d, lonvalue_2d, mask_1d, mask_2d &
    ...
    IMPLICIT NONE
      TYPE(xios_domaingroup) , INTENT(IN) :: domaingroup_hdl
      REAL (KIND=8) , OPTIONAL, INTENT(IN) :: area(:,:)
      REAL (KIND=8) , OPTIONAL, INTENT(IN) :: bounds_lat_1d(:,:)
      REAL (KIND=8) , OPTIONAL, INTENT(IN) :: bounds_lat_2d(:,:,:)
      CHARACTER(len = *) , OPTIONAL, INTENT(IN) :: bounds_lat_name
  ...
  END SUBROUTINE xios_set_domaingroup_attr_hdl
  SUBROUTINE xios_set_domaingroup_attr_hdl_ &
    ...
    IMPLICIT NONE
      ...
      ENDIF
  END SUBROUTINE xios_set_domaingroup_attr_hdl_
  SUBROUTINE xios_get_domaingroup_attr &
    ( domaingroup_id, area, bounds_lat_1d, bounds_lat_2d, bounds_lat_name, bounds_lon_1d, bounds_lon_2d &
    , bounds_lon_name, comment, data_dim, data_i_index, data_ibegin, data_j_index, data_jbegin, data_ni &
    , data_nj, dim_i_name, dim_j_name, domain_ref, group_ref, i_index, ibegin, j_index, jbegin, lat_name &
    , latvalue_1d, latvalue_2d, lon_name, long_name, lonvalue_1d, lonvalue_2d, mask_1d, mask_2d &
    ...
    IMPLICIT NONE
      ...
      CALL xios_get_domaingroup_handle &
      (domaingroup_id,domaingroup_hdl)
      CALL xios_get_domaingroup_attr_hdl_ &
      ( domaingroup_hdl, area, bounds_lat_1d, bounds_lat_2d, bounds_lat_name, bounds_lon_1d, bounds_lon_2d &
      , bounds_lon_name, comment, data_dim, data_i_index, data_ibegin, data_j_index, data_jbegin, data_ni &
      , data_nj, dim_i_name, dim_j_name, domain_ref, group_ref, i_index, ibegin, j_index, jbegin, lat_name &
      , latvalue_1d, latvalue_2d, lon_name, long_name, lonvalue_1d, lonvalue_2d, mask_1d, mask_2d &
  ...
  END SUBROUTINE xios_get_domaingroup_attr
  SUBROUTINE xios_get_domaingroup_attr_hdl &
    ( domaingroup_hdl, area, bounds_lat_1d, bounds_lat_2d, bounds_lat_name, bounds_lon_1d, bounds_lon_2d &
    , bounds_lon_name, comment, data_dim, data_i_index, data_ibegin, data_j_index, data_jbegin, data_ni &
    , data_nj, dim_i_name, dim_j_name, domain_ref, group_ref, i_index, ibegin, j_index, jbegin, lat_name &
    , latvalue_1d, latvalue_2d, lon_name, long_name, lonvalue_1d, lonvalue_2d, mask_1d, mask_2d &
  ...
  END SUBROUTINE xios_get_domaingroup_attr_hdl
  SUBROUTINE xios_get_domaingroup_attr_hdl_ &
    ( domaingroup_hdl, area_, bounds_lat_1d_, bounds_lat_2d_, bounds_lat_name_, bounds_lon_1d_, bounds_lon_2d_ &
    , bounds_lon_name_, comment_, data_dim_, data_i_index_, data_ibegin_, data_j_index_, data_jbegin_ &
    , data_ni_, data_nj_, dim_i_name_, dim_j_name_, domain_ref_, group_ref_, i_index_, ibegin_, j_index_ &
    , jbegin_, lat_name_, latvalue_1d_, latvalue_2d_, lon_name_, long_name_, lonvalue_1d_, lonvalue_2d_ &
    ...
    IMPLICIT NONE
      ...
      (domaingroup_hdl%daddr, type_, len(type_))
      ENDIF
  END SUBROUTINE xios_get_domaingroup_attr_hdl_
  SUBROUTINE xios_is_defined_domaingroup_attr &
    ( domaingroup_id, area, bounds_lat_1d, bounds_lat_2d, bounds_lat_name, bounds_lon_1d, bounds_lon_2d &
    , bounds_lon_name, comment, data_dim, data_i_index, data_ibegin, data_j_index, data_jbegin, data_ni &
    , data_nj, dim_i_name, dim_j_name, domain_ref, group_ref, i_index, ibegin, j_index, jbegin, lat_name &
    , latvalue_1d, latvalue_2d, lon_name, long_name, lonvalue_1d, lonvalue_2d, mask_1d, mask_2d &
    ...
    IMPLICIT NONE
      ...
      CALL xios_get_domaingroup_handle &
      (domaingroup_id,domaingroup_hdl)
      CALL xios_is_defined_domaingroup_attr_hdl_ &
      ( domaingroup_hdl, area, bounds_lat_1d, bounds_lat_2d, bounds_lat_name, bounds_lon_1d, bounds_lon_2d &
      , bounds_lon_name, comment, data_dim, data_i_index, data_ibegin, data_j_index, data_jbegin, data_ni &
      , data_nj, dim_i_name, dim_j_name, domain_ref, group_ref, i_index, ibegin, j_index, jbegin, lat_name &
      , latvalue_1d, latvalue_2d, lon_name, long_name, lonvalue_1d, lonvalue_2d, mask_1d, mask_2d &
  ...
  END SUBROUTINE xios_is_defined_domaingroup_attr
  SUBROUTINE xios_is_defined_domaingroup_attr_hdl &
    ( domaingroup_hdl, area, bounds_lat_1d, bounds_lat_2d, bounds_lat_name, bounds_lon_1d, bounds_lon_2d &
    , bounds_lon_name, comment, data_dim, data_i_index, data_ibegin, data_j_index, data_jbegin, data_ni &
    , data_nj, dim_i_name, dim_j_name, domain_ref, group_ref, i_index, ibegin, j_index, jbegin, lat_name &
    , latvalue_1d, latvalue_2d, lon_name, long_name, lonvalue_1d, lonvalue_2d, mask_1d, mask_2d &
  ...
  END SUBROUTINE xios_is_defined_domaingroup_attr_hdl
  SUBROUTINE xios_is_defined_domaingroup_attr_hdl_ &
    ( domaingroup_hdl, area_, bounds_lat_1d_, bounds_lat_2d_, bounds_lat_name_, bounds_lon_1d_, bounds_lon_2d_ &
    , bounds_lon_name_, comment_, data_dim_, data_i_index_, data_ibegin_, data_j_index_, data_jbegin_ &
    , data_ni_, data_nj_, dim_i_name_, dim_j_name_, domain_ref_, group_ref_, i_index_, ibegin_, j_index_ &
    , jbegin_, lat_name_, latvalue_1d_, latvalue_2d_, lon_name_, long_name_, lonvalue_1d_, lonvalue_2d_ &
    ...
    IMPLICIT NONE
      ...
      (domaingroup_hdl%daddr)
        type_ = type__tmp
      ENDIF
  END SUBROUTINE xios_is_defined_domaingroup_attr_hdl_
