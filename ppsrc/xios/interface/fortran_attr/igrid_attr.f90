...
CONTAINS
  SUBROUTINE xios_set_grid_attr &
    ...
    IMPLICIT NONE
      ...
      CALL xios_get_grid_handle &
      (grid_id,grid_hdl)
      CALL xios_set_grid_attr_hdl_ &
      ( grid_hdl, comment, description, mask_0d, mask_1d, mask_2d, mask_3d, mask_4d, mask_5d, mask_6d &
      , mask_7d, name )
  END SUBROUTINE xios_set_grid_attr
  SUBROUTINE xios_set_grid_attr_hdl &
    ( grid_hdl, comment, description, mask_0d, mask_1d, mask_2d, mask_3d, mask_4d, mask_5d, mask_6d &
    , mask_7d, name )
    IMPLICIT NONE
      TYPE(xios_grid) , INTENT(IN) :: grid_hdl
      CHARACTER(len = *) , OPTIONAL, INTENT(IN) :: comment
      CHARACTER(len = *) , OPTIONAL, INTENT(IN) :: description
      LOGICAL , OPTIONAL, INTENT(IN) :: mask_0d(:)
      LOGICAL (KIND=C_BOOL) , ALLOCATABLE :: mask_0d_tmp(:)
      ...
      ( grid_hdl, comment, description, mask_0d, mask_1d, mask_2d, mask_3d, mask_4d, mask_5d, mask_6d &
      , mask_7d, name )
  END SUBROUTINE xios_set_grid_attr_hdl
  SUBROUTINE xios_set_grid_attr_hdl_ &
    ...
    IMPLICIT NONE
      ...
      ENDIF
  END SUBROUTINE xios_set_grid_attr_hdl_
  SUBROUTINE xios_get_grid_attr &
    ( grid_id, comment, description, mask_0d, mask_1d, mask_2d, mask_3d, mask_4d, mask_5d, mask_6d &
    , mask_7d, name )
    IMPLICIT NONE
      TYPE(xios_grid) :: grid_hdl
      ...
      CALL xios_get_grid_handle &
      (grid_id,grid_hdl)
      CALL xios_get_grid_attr_hdl_ &
      ( grid_hdl, comment, description, mask_0d, mask_1d, mask_2d, mask_3d, mask_4d, mask_5d, mask_6d &
      , mask_7d, name )
  END SUBROUTINE xios_get_grid_attr
  SUBROUTINE xios_get_grid_attr_hdl &
    ( grid_hdl, comment, description, mask_0d, mask_1d, mask_2d, mask_3d, mask_4d, mask_5d, mask_6d &
    , mask_7d, name )
    IMPLICIT NONE
      TYPE(xios_grid) , INTENT(IN) :: grid_hdl
      ...
      ( grid_hdl, comment, description, mask_0d, mask_1d, mask_2d, mask_3d, mask_4d, mask_5d, mask_6d &
      , mask_7d, name )
  END SUBROUTINE xios_get_grid_attr_hdl
  SUBROUTINE xios_get_grid_attr_hdl_ &
    ( grid_hdl, comment_, description_, mask_0d_, mask_1d_, mask_2d_, mask_3d_, mask_4d_, mask_5d_ &
    , mask_6d_, mask_7d_, name_ )
    IMPLICIT NONE
      TYPE(xios_grid) , INTENT(IN) :: grid_hdl
      ...
      (grid_hdl%daddr, name_, len(name_))
      ENDIF
  END SUBROUTINE xios_get_grid_attr_hdl_
  SUBROUTINE xios_is_defined_grid_attr &
    ( grid_id, comment, description, mask_0d, mask_1d, mask_2d, mask_3d, mask_4d, mask_5d, mask_6d &
    , mask_7d, name )
    IMPLICIT NONE
      TYPE(xios_grid) :: grid_hdl
      ...
      CALL xios_get_grid_handle &
      (grid_id,grid_hdl)
      CALL xios_is_defined_grid_attr_hdl_ &
      ( grid_hdl, comment, description, mask_0d, mask_1d, mask_2d, mask_3d, mask_4d, mask_5d, mask_6d &
      , mask_7d, name )
  END SUBROUTINE xios_is_defined_grid_attr
  SUBROUTINE xios_is_defined_grid_attr_hdl &
    ( grid_hdl, comment, description, mask_0d, mask_1d, mask_2d, mask_3d, mask_4d, mask_5d, mask_6d &
    , mask_7d, name )
    IMPLICIT NONE
      TYPE(xios_grid) , INTENT(IN) :: grid_hdl
      ...
      ( grid_hdl, comment, description, mask_0d, mask_1d, mask_2d, mask_3d, mask_4d, mask_5d, mask_6d &
      , mask_7d, name )
  END SUBROUTINE xios_is_defined_grid_attr_hdl
  SUBROUTINE xios_is_defined_grid_attr_hdl_ &
    ( grid_hdl, comment_, description_, mask_0d_, mask_1d_, mask_2d_, mask_3d_, mask_4d_, mask_5d_ &
    , mask_6d_, mask_7d_, name_ )
    IMPLICIT NONE
      TYPE(xios_grid) , INTENT(IN) :: grid_hdl
      ...
      (grid_hdl%daddr)
        name_ = name__tmp
      ENDIF
  END SUBROUTINE xios_is_defined_grid_attr_hdl_
