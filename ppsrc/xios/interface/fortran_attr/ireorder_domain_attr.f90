...
CONTAINS
  SUBROUTINE xios_set_reorder_domain_attr &
    ( reorder_domain_id, invert_lat, max_lon, min_lon, shift_lon_fraction )
    IMPLICIT NONE
      TYPE(xios_reorder_domain) :: reorder_domain_hdl
      ...
      CALL xios_get_reorder_domain_handle &
      (reorder_domain_id,reorder_domain_hdl)
      CALL xios_set_reorder_domain_attr_hdl_ &
      ( reorder_domain_hdl, invert_lat, max_lon, min_lon, shift_lon_fraction )
  END SUBROUTINE xios_set_reorder_domain_attr
  SUBROUTINE xios_set_reorder_domain_attr_hdl &
    ( reorder_domain_hdl, invert_lat, max_lon, min_lon, shift_lon_fraction )
    IMPLICIT NONE
      TYPE(xios_reorder_domain) , INTENT(IN) :: reorder_domain_hdl
      LOGICAL , OPTIONAL, INTENT(IN) :: invert_lat
      LOGICAL (KIND=C_BOOL) :: invert_lat_tmp
      REAL (KIND=8) , OPTIONAL, INTENT(IN) :: max_lon
      REAL (KIND=8) , OPTIONAL, INTENT(IN) :: min_lon
      ...
      CALL xios_set_reorder_domain_attr_hdl_ &
      ( reorder_domain_hdl, invert_lat, max_lon, min_lon, shift_lon_fraction )
  END SUBROUTINE xios_set_reorder_domain_attr_hdl
  SUBROUTINE xios_set_reorder_domain_attr_hdl_ &
    ...
    IMPLICIT NONE
      ...
      ENDIF
  END SUBROUTINE xios_set_reorder_domain_attr_hdl_
  SUBROUTINE xios_get_reorder_domain_attr &
    ( reorder_domain_id, invert_lat, max_lon, min_lon, shift_lon_fraction )
    IMPLICIT NONE
      TYPE(xios_reorder_domain) :: reorder_domain_hdl
      CHARACTER(LEN=*), INTENT(IN) ::reorder_domain_id
      ...
      CALL xios_get_reorder_domain_handle &
      (reorder_domain_id,reorder_domain_hdl)
      CALL xios_get_reorder_domain_attr_hdl_ &
      ( reorder_domain_hdl, invert_lat, max_lon, min_lon, shift_lon_fraction )
  END SUBROUTINE xios_get_reorder_domain_attr
  SUBROUTINE xios_get_reorder_domain_attr_hdl &
    ( reorder_domain_hdl, invert_lat, max_lon, min_lon, shift_lon_fraction )
    IMPLICIT NONE
      TYPE(xios_reorder_domain) , INTENT(IN) :: reorder_domain_hdl
      LOGICAL , OPTIONAL, INTENT(OUT) :: invert_lat
      ...
      CALL xios_get_reorder_domain_attr_hdl_ &
      ( reorder_domain_hdl, invert_lat, max_lon, min_lon, shift_lon_fraction )
  END SUBROUTINE xios_get_reorder_domain_attr_hdl
  SUBROUTINE xios_get_reorder_domain_attr_hdl_ &
    ( reorder_domain_hdl, invert_lat_, max_lon_, min_lon_, shift_lon_fraction_ )
    IMPLICIT NONE
      TYPE(xios_reorder_domain) , INTENT(IN) :: reorder_domain_hdl
      ...
      (reorder_domain_hdl%daddr, shift_lon_fraction_)
      ENDIF
  END SUBROUTINE xios_get_reorder_domain_attr_hdl_
  SUBROUTINE xios_is_defined_reorder_domain_attr &
    ( reorder_domain_id, invert_lat, max_lon, min_lon, shift_lon_fraction )
    IMPLICIT NONE
      TYPE(xios_reorder_domain) :: reorder_domain_hdl
      CHARACTER(LEN=*), INTENT(IN) ::reorder_domain_id
      ...
      CALL xios_get_reorder_domain_handle &
      (reorder_domain_id,reorder_domain_hdl)
      CALL xios_is_defined_reorder_domain_attr_hdl_ &
      ( reorder_domain_hdl, invert_lat, max_lon, min_lon, shift_lon_fraction )
  END SUBROUTINE xios_is_defined_reorder_domain_attr
  SUBROUTINE xios_is_defined_reorder_domain_attr_hdl &
    ( reorder_domain_hdl, invert_lat, max_lon, min_lon, shift_lon_fraction )
    IMPLICIT NONE
      TYPE(xios_reorder_domain) , INTENT(IN) :: reorder_domain_hdl
      LOGICAL, OPTIONAL, INTENT(OUT) :: invert_lat
      ...
      CALL xios_is_defined_reorder_domain_attr_hdl_ &
      ( reorder_domain_hdl, invert_lat, max_lon, min_lon, shift_lon_fraction )
  END SUBROUTINE xios_is_defined_reorder_domain_attr_hdl
  SUBROUTINE xios_is_defined_reorder_domain_attr_hdl_ &
    ( reorder_domain_hdl, invert_lat_, max_lon_, min_lon_, shift_lon_fraction_ )
    IMPLICIT NONE
      TYPE(xios_reorder_domain) , INTENT(IN) :: reorder_domain_hdl
      LOGICAL, OPTIONAL, INTENT(OUT) :: invert_lat_
      ...
      ENDIF
  END SUBROUTINE xios_is_defined_reorder_domain_attr_hdl_
