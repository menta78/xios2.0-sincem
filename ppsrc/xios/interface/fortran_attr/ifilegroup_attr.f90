...
CONTAINS
  SUBROUTINE xios_set_filegroup_attr &
    ...
    IMPLICIT NONE
      ...
      CALL xios_get_filegroup_handle &
      (filegroup_id,filegroup_hdl)
      CALL xios_set_filegroup_attr_hdl_ &
  ...
  SUBROUTINE xios_set_filegroup_attr_hdl &
    ( filegroup_hdl, append, comment, compression_level, convention, convention_str, cyclic, description &
    , enabled, format, group_ref, min_digits, mode, name, name_suffix, output_freq, output_level &
    , par_access, read_metadata_par, record_offset, split_end_offset, split_freq, split_freq_format &
    , split_last_date, split_start_offset, sync_freq, time_counter, time_counter_name, time_stamp_format &
    , time_stamp_name, time_units, timeseries, ts_prefix, type, uuid_format, uuid_name )
    IMPLICIT NONE
      TYPE(xios_filegroup) , INTENT(IN) :: filegroup_hdl
      LOGICAL , OPTIONAL, INTENT(IN) :: append
      LOGICAL (KIND=C_BOOL) :: append_tmp
      CHARACTER(len = *) , OPTIONAL, INTENT(IN) :: comment
      INTEGER , OPTIONAL, INTENT(IN) :: compression_level
      ...
      , split_last_date, split_start_offset, sync_freq, time_counter, time_counter_name, time_stamp_format &
      , time_stamp_name, time_units, timeseries, ts_prefix, type, uuid_format, uuid_name )
  END SUBROUTINE xios_set_filegroup_attr_hdl
  SUBROUTINE xios_set_filegroup_attr_hdl_ &
    ...
    IMPLICIT NONE
      ...
      TYPE(xios_duration) , OPTIONAL, INTENT(IN) :: output_freq_
      ...
      TYPE(xios_duration) , OPTIONAL, INTENT(IN) :: split_end_offset_
      TYPE(xios_duration) , OPTIONAL, INTENT(IN) :: split_freq_
      CHARACTER(len = *) , OPTIONAL, INTENT(IN) :: split_freq_format_
      CHARACTER(len = *) , OPTIONAL, INTENT(IN) :: split_last_date_
      TYPE(xios_duration) , OPTIONAL, INTENT(IN) :: split_start_offset_
      TYPE(xios_duration) , OPTIONAL, INTENT(IN) :: sync_freq_
      ...
      ENDIF
  END SUBROUTINE xios_set_filegroup_attr_hdl_
  SUBROUTINE xios_get_filegroup_attr &
    ( filegroup_id, append, comment, compression_level, convention, convention_str, cyclic, description &
    , enabled, format, group_ref, min_digits, mode, name, name_suffix, output_freq, output_level &
    , par_access, read_metadata_par, record_offset, split_end_offset, split_freq, split_freq_format &
    , split_last_date, split_start_offset, sync_freq, time_counter, time_counter_name, time_stamp_format &
    ...
    IMPLICIT NONE
      ...
      TYPE(xios_duration) , OPTIONAL, INTENT(OUT) :: split_end_offset
      TYPE(xios_duration) , OPTIONAL, INTENT(OUT) :: split_freq
      CHARACTER(len = *) , OPTIONAL, INTENT(OUT) :: split_freq_format
      CHARACTER(len = *) , OPTIONAL, INTENT(OUT) :: split_last_date
      TYPE(xios_duration) , OPTIONAL, INTENT(OUT) :: split_start_offset
      TYPE(xios_duration) , OPTIONAL, INTENT(OUT) :: sync_freq
      ...
      CALL xios_get_filegroup_handle &
      (filegroup_id,filegroup_hdl)
      CALL xios_get_filegroup_attr_hdl_ &
      ( filegroup_hdl, append, comment, compression_level, convention, convention_str, cyclic, description &
      , enabled, format, group_ref, min_digits, mode, name, name_suffix, output_freq, output_level &
      , par_access, read_metadata_par, record_offset, split_end_offset, split_freq, split_freq_format &
      , split_last_date, split_start_offset, sync_freq, time_counter, time_counter_name, time_stamp_format &
      , time_stamp_name, time_units, timeseries, ts_prefix, type, uuid_format, uuid_name )
  END SUBROUTINE xios_get_filegroup_attr
  SUBROUTINE xios_get_filegroup_attr_hdl &
    ( filegroup_hdl, append, comment, compression_level, convention, convention_str, cyclic, description &
    , enabled, format, group_ref, min_digits, mode, name, name_suffix, output_freq, output_level &
    , par_access, read_metadata_par, record_offset, split_end_offset, split_freq, split_freq_format &
    , split_last_date, split_start_offset, sync_freq, time_counter, time_counter_name, time_stamp_format &
    ...
    IMPLICIT NONE
      ...
      , split_last_date, split_start_offset, sync_freq, time_counter, time_counter_name, time_stamp_format &
      , time_stamp_name, time_units, timeseries, ts_prefix, type, uuid_format, uuid_name )
  END SUBROUTINE xios_get_filegroup_attr_hdl
  SUBROUTINE xios_get_filegroup_attr_hdl_ &
    ( filegroup_hdl, append_, comment_, compression_level_, convention_, convention_str_, cyclic_ &
    , description_, enabled_, format_, group_ref_, min_digits_, mode_, name_, name_suffix_, output_freq_ &
    , output_level_, par_access_, read_metadata_par_, record_offset_, split_end_offset_, split_freq_ &
    , split_freq_format_, split_last_date_, split_start_offset_, sync_freq_, time_counter_, time_counter_name_ &
    ...
    IMPLICIT NONE
      ...
      TYPE(xios_duration) , OPTIONAL, INTENT(OUT) :: output_freq_
      ...
      TYPE(xios_duration) , OPTIONAL, INTENT(OUT) :: split_end_offset_
      TYPE(xios_duration) , OPTIONAL, INTENT(OUT) :: split_freq_
      CHARACTER(len = *) , OPTIONAL, INTENT(OUT) :: split_freq_format_
      CHARACTER(len = *) , OPTIONAL, INTENT(OUT) :: split_last_date_
      TYPE(xios_duration) , OPTIONAL, INTENT(OUT) :: split_start_offset_
      TYPE(xios_duration) , OPTIONAL, INTENT(OUT) :: sync_freq_
      ...
      (filegroup_hdl%daddr, uuid_name_, len(uuid_name_))
      ENDIF
  END SUBROUTINE xios_get_filegroup_attr_hdl_
  SUBROUTINE xios_is_defined_filegroup_attr &
    ( filegroup_id, append, comment, compression_level, convention, convention_str, cyclic, description &
    , enabled, format, group_ref, min_digits, mode, name, name_suffix, output_freq, output_level &
    , par_access, read_metadata_par, record_offset, split_end_offset, split_freq, split_freq_format &
    , split_last_date, split_start_offset, sync_freq, time_counter, time_counter_name, time_stamp_format &
    ...
    IMPLICIT NONE
      ...
      CALL xios_get_filegroup_handle &
      (filegroup_id,filegroup_hdl)
      CALL xios_is_defined_filegroup_attr_hdl_ &
      ( filegroup_hdl, append, comment, compression_level, convention, convention_str, cyclic, description &
      , enabled, format, group_ref, min_digits, mode, name, name_suffix, output_freq, output_level &
      , par_access, read_metadata_par, record_offset, split_end_offset, split_freq, split_freq_format &
      , split_last_date, split_start_offset, sync_freq, time_counter, time_counter_name, time_stamp_format &
      , time_stamp_name, time_units, timeseries, ts_prefix, type, uuid_format, uuid_name )
  END SUBROUTINE xios_is_defined_filegroup_attr
  SUBROUTINE xios_is_defined_filegroup_attr_hdl &
    ( filegroup_hdl, append, comment, compression_level, convention, convention_str, cyclic, description &
    , enabled, format, group_ref, min_digits, mode, name, name_suffix, output_freq, output_level &
    , par_access, read_metadata_par, record_offset, split_end_offset, split_freq, split_freq_format &
    , split_last_date, split_start_offset, sync_freq, time_counter, time_counter_name, time_stamp_format &
    ...
    IMPLICIT NONE
      ...
      , split_last_date, split_start_offset, sync_freq, time_counter, time_counter_name, time_stamp_format &
      , time_stamp_name, time_units, timeseries, ts_prefix, type, uuid_format, uuid_name )
  END SUBROUTINE xios_is_defined_filegroup_attr_hdl
  SUBROUTINE xios_is_defined_filegroup_attr_hdl_ &
    ( filegroup_hdl, append_, comment_, compression_level_, convention_, convention_str_, cyclic_ &
    , description_, enabled_, format_, group_ref_, min_digits_, mode_, name_, name_suffix_, output_freq_ &
    , output_level_, par_access_, read_metadata_par_, record_offset_, split_end_offset_, split_freq_ &
    , split_freq_format_, split_last_date_, split_start_offset_, sync_freq_, time_counter_, time_counter_name_ &
    ...
    IMPLICIT NONE
      ...
      ENDIF
  END SUBROUTINE xios_is_defined_filegroup_attr_hdl_
