...
CONTAINS
  SUBROUTINE xios_set_fieldgroup_attr &
    ...
    IMPLICIT NONE
      ...
      CALL xios_get_fieldgroup_handle &
      (fieldgroup_id,fieldgroup_hdl)
      CALL xios_set_fieldgroup_attr_hdl_ &
  ...
  SUBROUTINE xios_set_fieldgroup_attr_hdl_ &
    ...
    IMPLICIT NONE
      ...
      ENDIF
  END SUBROUTINE xios_set_fieldgroup_attr_hdl_
  SUBROUTINE xios_get_fieldgroup_attr &
    ( fieldgroup_id, add_offset, axis_ref, cell_methods, cell_methods_mode, check_if_active, comment &
    , compression_level, default_value, detect_missing_value, domain_ref, enabled, expr, field_ref &
    , freq_offset, freq_op, grid_path, grid_ref, group_ref, indexed_output, level, long_name, name &
    , operation, prec, read_access, scalar_ref, scale_factor, standard_name, ts_enabled, ts_split_freq &
    ...
    IMPLICIT NONE
      ...
      CALL xios_get_fieldgroup_handle &
      (fieldgroup_id,fieldgroup_hdl)
      CALL xios_get_fieldgroup_attr_hdl_ &
      ( fieldgroup_hdl, add_offset, axis_ref, cell_methods, cell_methods_mode, check_if_active, comment &
      , compression_level, default_value, detect_missing_value, domain_ref, enabled, expr, field_ref &
      , freq_offset, freq_op, grid_path, grid_ref, group_ref, indexed_output, level, long_name, name &
      , operation, prec, read_access, scalar_ref, scale_factor, standard_name, ts_enabled, ts_split_freq &
      , unit, valid_max, valid_min )
  END SUBROUTINE xios_get_fieldgroup_attr
  SUBROUTINE xios_get_fieldgroup_attr_hdl &
    ( fieldgroup_hdl, add_offset, axis_ref, cell_methods, cell_methods_mode, check_if_active, comment &
    , compression_level, default_value, detect_missing_value, domain_ref, enabled, expr, field_ref &
    , freq_offset, freq_op, grid_path, grid_ref, group_ref, indexed_output, level, long_name, name &
    , operation, prec, read_access, scalar_ref, scale_factor, standard_name, ts_enabled, ts_split_freq &
    ...
    IMPLICIT NONE
      ...
      , operation, prec, read_access, scalar_ref, scale_factor, standard_name, ts_enabled, ts_split_freq &
      , unit, valid_max, valid_min )
  END SUBROUTINE xios_get_fieldgroup_attr_hdl
  SUBROUTINE xios_get_fieldgroup_attr_hdl_ &
    ( fieldgroup_hdl, add_offset_, axis_ref_, cell_methods_, cell_methods_mode_, check_if_active_ &
    , comment_, compression_level_, default_value_, detect_missing_value_, domain_ref_, enabled_ &
    , expr_, field_ref_, freq_offset_, freq_op_, grid_path_, grid_ref_, group_ref_, indexed_output_ &
    , level_, long_name_, name_, operation_, prec_, read_access_, scalar_ref_, scale_factor_, standard_name_ &
    ...
    IMPLICIT NONE
      ...
      (fieldgroup_hdl%daddr, valid_min_)
      ENDIF
  END SUBROUTINE xios_get_fieldgroup_attr_hdl_
  SUBROUTINE xios_is_defined_fieldgroup_attr &
    ( fieldgroup_id, add_offset, axis_ref, cell_methods, cell_methods_mode, check_if_active, comment &
    , compression_level, default_value, detect_missing_value, domain_ref, enabled, expr, field_ref &
    , freq_offset, freq_op, grid_path, grid_ref, group_ref, indexed_output, level, long_name, name &
    , operation, prec, read_access, scalar_ref, scale_factor, standard_name, ts_enabled, ts_split_freq &
    ...
    IMPLICIT NONE
      ...
      CALL xios_get_fieldgroup_handle &
      (fieldgroup_id,fieldgroup_hdl)
      CALL xios_is_defined_fieldgroup_attr_hdl_ &
      ( fieldgroup_hdl, add_offset, axis_ref, cell_methods, cell_methods_mode, check_if_active, comment &
      , compression_level, default_value, detect_missing_value, domain_ref, enabled, expr, field_ref &
      , freq_offset, freq_op, grid_path, grid_ref, group_ref, indexed_output, level, long_name, name &
      , operation, prec, read_access, scalar_ref, scale_factor, standard_name, ts_enabled, ts_split_freq &
      , unit, valid_max, valid_min )
  END SUBROUTINE xios_is_defined_fieldgroup_attr
  SUBROUTINE xios_is_defined_fieldgroup_attr_hdl &
    ( fieldgroup_hdl, add_offset, axis_ref, cell_methods, cell_methods_mode, check_if_active, comment &
    , compression_level, default_value, detect_missing_value, domain_ref, enabled, expr, field_ref &
    , freq_offset, freq_op, grid_path, grid_ref, group_ref, indexed_output, level, long_name, name &
    , operation, prec, read_access, scalar_ref, scale_factor, standard_name, ts_enabled, ts_split_freq &
    ...
    IMPLICIT NONE
      ...
      , operation, prec, read_access, scalar_ref, scale_factor, standard_name, ts_enabled, ts_split_freq &
      , unit, valid_max, valid_min )
  END SUBROUTINE xios_is_defined_fieldgroup_attr_hdl
  SUBROUTINE xios_is_defined_fieldgroup_attr_hdl_ &
    ( fieldgroup_hdl, add_offset_, axis_ref_, cell_methods_, cell_methods_mode_, check_if_active_ &
    , comment_, compression_level_, default_value_, detect_missing_value_, domain_ref_, enabled_ &
    , expr_, field_ref_, freq_offset_, freq_op_, grid_path_, grid_ref_, group_ref_, indexed_output_ &
    , level_, long_name_, name_, operation_, prec_, read_access_, scalar_ref_, scale_factor_, standard_name_ &
    ...
    IMPLICIT NONE
      ...
      ENDIF
  END SUBROUTINE xios_is_defined_fieldgroup_attr_hdl_
