...
USE icontext, ONLY : xios_context, xios_set_current_context, xios_get_current_context, xios_is_valid_context
...
USE idata, ONLY : xios_initialize, xios_init_server, xios_finalize, xios_context_initialize, xios_context_is_initialized, &
                  xios_close_context_definition, xios_context_finalize, xios_solve_inheritance, xios_oasis_enddef
...
USE idate, ONLY : xios_date, &
                  ...
                  ASSIGNMENT(=)
USE itimer, ONLY : xios_timer_resume, xios_timer_suspend, xios_timer_reset, xios_timer_get_time
